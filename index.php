        ...
        <div class="row align-items-center position-relative">
          <div class="col-lg-6">
            <div class="hero-content">
              ...
              <p class="wow fadeInUp">
                Menambah wawasan kosakata sehari-hari di Indonesia bagian timur.
              </p>
              <!-- <a
          ...
          <div class="col-lg-6">
            <div class="hero-img wow fadeInUp">
              <img src="assets/img/hero/hero3.jpg" alt="" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
                  ...
                  <table id="table1" class="table table-bordered">
                    ...
                    include 'db.php';
                      ...
                      while ($info=mysqli_fetch_array($query)) {
                        ?>
                        <tr>
                          <td><?php echo $info['kata']; ?></td>
                          <td><?php echo $info['arti']; ?></td>
                        </tr>
            ...
            <div class="single-feature">
              ...
              <div class="content">
                <form class="" action="" method="post">
                  <input type="text" name="kata" value="" placeholder="cari kata" class="form-control">
                  <input type="submit" name="search" value="Search" class="form-control mt-1" style="width:auto">
                </form>
                <table id="table2" class="table table-bordered mt-2">
                  <tr>
                    <th>Kata</th>
                    <th>Arti</th>
                  </tr>
                  <?php
                    ...
                    if (isset($_POST['search'])) {
                      ...
                      $sql1="SELECT * from kamus where kata='$word' or arti='$word'";
          ...
          <div class="col-lg-4 col-md-8 col-sm-10">
            <div class="single-feature">
              ...
              <div class="content">
                <form class="" action="" method="post">
                  <h3>Masukkan Kosakata Baru</h3>
                  <!-- <label for="" style="">Kata</label><br> -->
                  <input type="text" name="kata" value="" placeholder="Masukkan Kata" required class="form-control mt-2" style="width:auto">
                  <!-- <label for="">Arti</label><br> -->
                  <input type="text" name="arti" value="" placeholder="Masukkan Arti" required class="form-control mt-2" style="width:auto">
                  <input type="submit" name="insert" value="Kirim" class="form-control mt-3" style="width:auto">
                </form>
                <?php
                  include 'db.php';
                  if (isset($_POST['insert'])) {
                    ...
                    $sql="INSERT INTO kamus(kata,arti) values('$word','$meaning')";
                    $query=mysqli_query($conn,$sql);
